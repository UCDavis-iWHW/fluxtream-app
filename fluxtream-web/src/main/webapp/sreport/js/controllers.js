var selfReportControllers = angular.module('sreportControllers', []);

selfReportControllers.controller('TopicsController', ['$scope', '$http',
    function ($scope, $http) {
        $scope.topics = [
...
selfReportControllers.controller('CreateObservationController', ['$scope', '$routeParams',
